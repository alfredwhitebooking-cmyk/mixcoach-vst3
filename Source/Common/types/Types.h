...
struct alignas(32) TrackTelemetry {
    ...
    float crestPerBand[6] = { 0.0f };   // Crest factor in 6 broad frequency regions (Sub, Bass, LoMid, HiMid, Presence, Air)
...
{
    switch (dest) {
        case MasterDestination::Spotify:          return -14.0f;
        case MasterDestination::AppleMusic:       return -16.0f;
        case MasterDestination::YouTube:          return -14.0f;
        case MasterDestination::Club:             return -8.0f;
        case MasterDestination::StreamingGeneral: return -14.0f;
        case MasterDestination::CD:               return -9.0f;
...
{
    switch (dest) {
        case MasterDestination::Spotify:          return -1.0f;
        case MasterDestination::AppleMusic:       return -1.0f;
        case MasterDestination::YouTube:          return -1.0f;
        case MasterDestination::Club:             return -0.5f;
        case MasterDestination::StreamingGeneral: return -1.0f;
        case MasterDestination::CD:               return -0.1f;
        default:                                  return -1.0f;
    }
}
