...
struct SharedMemoryHeader {
    ...
    static constexpr uint32_t kCurrentStructVersion = 2;
...
static constexpr uint32_t kSharedMemoryStructVersion = 2;
...
public:
    ...
    bool initialize(const juce::String& mapName = "MixCoach_SharedMemory_v2");
