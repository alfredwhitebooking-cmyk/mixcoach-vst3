...
public:
    ...
    [[nodiscard]] const std::vector<SessionChange>& getSessionHistory() const noexcept
    {
...
private:
    ...
    juce::String dawName_ = "FL Studio"; // DAW por defecto (el usuario usa FL Studio). Se puede cambiar via setHostName() o cuando getHostProperties() esté disponible.
};
