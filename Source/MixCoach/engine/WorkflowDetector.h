...
public:
    ...
    void updateTracking(int slotIndex,
...
private:
    ...
    void detectFaderChange(TrackState& track, int slotIndex, int64_t nowUs,
                           std::vector<WorkflowEvent>& events);
    void detectEQChange(TrackState& track, int slotIndex, int64_t nowUs,
                        std::vector<WorkflowEvent>& events);
    void detectDynamicsChange(TrackState& track, int slotIndex, int64_t nowUs,
                              std::vector<WorkflowEvent>& events);
    void detectPanChange(TrackState& track, int slotIndex, int64_t nowUs,
                         std::vector<WorkflowEvent>& events);
    void detectMuteChange(TrackState& track, int slotIndex, int64_t nowUs,
                          std::vector<WorkflowEvent>& events);
    ...
    static int  findWorstRegion(const float baseline[6], const float current[6],
                                float& magnitudeDb);

    /** Convierte 30-bandas a perfil de 6 regiones. */
    static void computeRegionProfile(const float bandEnergies[30],
                                     float regionProfile[6]);
