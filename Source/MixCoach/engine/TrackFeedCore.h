...
public:
    ...
    void updateTrackState(int slotIndex,
    ...
    [[nodiscard]] std::vector<TrackEvent> getRecentEvents(int trackId,
                                                           int maxEvents = 16) const;
    ...
    void clearReferenceGapProfile() noexcept {
        referenceGapProfile_.fill(0.0f);
    }
