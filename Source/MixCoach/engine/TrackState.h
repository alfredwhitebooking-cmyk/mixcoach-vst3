...
namespace mixcoach {
    ...
    struct TrackEvent
    {
        ...
        [[nodiscard]] bool isProblem() const noexcept { return severity > 0.5f; }
    };
    ...
    struct TrackState
    {
        ...
        [[nodiscard]] bool hasSignal() const noexcept { return peakCombined > -60.0f && timestampUs > 0; }

        [[nodiscard]] bool isClipping() const noexcept { return peakCombined > -0.5f; }

        [[nodiscard]] float getPeakCombinedDb() const noexcept { return juce::jmax(peakLeft, peakRight); }

        [[nodiscard]] float getRmsCombinedDb() const noexcept { return juce::jmax(rmsLeft, rmsRight); }
