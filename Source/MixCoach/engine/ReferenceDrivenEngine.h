...
public:
    ...
    static std::vector<DomainGap> computeGaps(
        const ReferenceFingerprint& fp,
        const AudioAnalyzer& master,
        const juce::String& genre = "Unknown");
...
private:
    ...
    static DomainGap analyzeGainDomain(
        const ReferenceFingerprint& fp,
        const AudioAnalyzer& master);

    static std::vector<DomainGap> analyzeTonalDomain(
        const ReferenceFingerprint& fp,
        const AudioAnalyzer& master);

    static DomainGap analyzeDynamicsDomain(
        const ReferenceFingerprint& fp,
        const AudioAnalyzer& master);

    static DomainGap analyzeSpatialDomain(
        const ReferenceFingerprint& fp,
        const AudioAnalyzer& master);

    static DomainGap analyzeLoudnessRangeDomain(
        const ReferenceFingerprint& fp,
        const AudioAnalyzer& master);
