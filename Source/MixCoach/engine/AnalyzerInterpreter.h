...
namespace mixcoach {
    ...
    public:
        ...
        static AnalyzerInterpretation interpretCorrelation(float correlation, const juce::String& genre = {});

        /** Interpreta el crest factor (dinámica).
            @param crestDb  Crest factor en dB (Peak - RMS)
            @param genre    Género musical (para contexto) */
        static AnalyzerInterpretation interpretCrest(float crestDb, const juce::String& genre = {});
        ...
        static AnalyzerInterpretation interpretCentroid(float centroidRatio, const juce::String& genre = {});
        ...
        /** Interpreta métricas de loudness (LUFS + True Peak + LRA).
            ...
            @param genre           Género musical */
        static AnalyzerInterpretation
        interpretLUFS(float integratedLUFS, float truePeakDBTP, float lra, const juce::String& genre = {});
        ...
        static AnalyzerInterpretation interpretPhaseScope(float correlation, float stereoWidth);
        ...
        static std::vector<BandDiagnostic>
        toBandDiagnostics(const std::vector<AnalyzerInterpretation>& interpretations);
        ...
        static juce::String formatCoachMessage(const std::vector<AnalyzerInterpretation>& interpretations,
                                               int maxEntries = 3);
        ...
        static AnalyzerInterpretation interpretGain(float peakLeft, float peakRight, float rmsLeft, float rmsRight);
        ...
        static AnalyzerInterpretation interpretStereoWidth(const float stereoWidthPerBand[6], float avgStereoWidth);
        ...
        static AnalyzerInterpretation
        interpretMidSide(const float midEnergyPerBand[6], const float sideEnergyPerBand[6], float avgStereoWidth);
    ...
    private:
        ...
        static constexpr const char* kBandNames[7] = {"Sub", "Bass", "Low-Mid", "High-Mid", "Presence", "High", "Air"};
