...
namespace mixcoach {
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    class ReferencePanelComponent : public juce::Component, private juce::Timer
    {
    public:
        ...
        void setPlayingRefIndex(int index)
        {
            playingRefIndex_ = index;
            repaint();
        }
        ...
        void restoreFromPaths(const std::vector<juce::String>& filePaths, const std::vector<juce::String>& urls);
