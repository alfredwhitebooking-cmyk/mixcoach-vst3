...
namespace mixcoach {
    ...
    private:
        ...
        void drawBusHeader(juce::Graphics& g, const juce::Rectangle<int>& area, int busIdx, int count);
        void drawTrackCard(juce::Graphics& g, juce::Rectangle<int> bounds, const TrackEntry& entry);
