...
private:
    struct VUPoint { float db; float pct; };
    static constexpr VUPoint vuScale_[11] = {
        { -20.0f, 0.00f }, { -10.0f, 0.25f }, {  -7.0f, 0.35f },
        {  -5.0f, 0.45f }, {  -3.0f, 0.58f }, {  -2.0f, 0.65f },
        {  -1.0f, 0.72f }, {   0.0f, 0.82f }, {   1.0f, 0.88f },
        {   2.0f, 0.94f }, {   3.0f, 1.00f }
    };
    ...
    void drawStaticDialFace(juce::Graphics& g, juce::Rectangle<float> bounds,
                            float cx, float cy, float radius);
    void drawNeedle(juce::Graphics& g, float cx, float cy,
