...
private:
    ...
    // ─── Sub-elementos ───────────────────────────────────────────────────
    void drawPeakBar(juce::Graphics& g, juce::Rectangle<float> bounds,
                     float level, float peakHold);
    void drawLufsBar(juce::Graphics& g, juce::Rectangle<float> bounds,
                     float level, float targetLUFS);
    void drawStatModule(juce::Graphics& g, juce::Rectangle<int> bounds,
    ...
    void drawDbScale(juce::Graphics& g, juce::Rectangle<float> bounds,
                     ...
                     float highlightVal = -999.0f, bool isLufsScale = false);
