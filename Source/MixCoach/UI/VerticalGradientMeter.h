...
namespace mixcoach {
    ...
    struct VerticalGradientMeter
    {
        ...
        static void drawDbScale(juce::Graphics& g, juce::Rectangle<float> bounds, bool topIsZero = true);

        static void
        drawGradientBar(juce::Graphics& g, juce::Rectangle<float> bounds, float levelDb, float radius = 1.5f);

        static void drawSolidBar(
            juce::Graphics& g, juce::Rectangle<float> bounds, float levelDb, juce::Colour colour, float radius = 1.5f);

        static void drawPeakTriangle(juce::Graphics& g,
        ...
        static void
        drawPeakReadout(juce::Graphics& g, juce::Rectangle<float> bounds, float peakDb, juce::Colour colour);
    };
