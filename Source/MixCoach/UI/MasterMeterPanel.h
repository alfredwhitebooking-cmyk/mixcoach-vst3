...
private:
    ...
    // ─── Preset system ─────────────────────────────────────────────────────
    enum Preset : uint8_t {
        Streaming, Spotify, YouTube, AppleMusic, Broadcast, Custom
    };
    ...
    void drawBigValue(juce::Graphics& g, juce::Rectangle<float> cell,
    ...
    // ─── Stats ─────────────────────────────────────────────────────────────
    float getTargetDelta(float current, float target) const noexcept {
