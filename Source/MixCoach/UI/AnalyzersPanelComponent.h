...
namespace mixcoach {
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    class PhaseScopePanel : public juce::Component, public juce::ChangeListener
    {
    public:
        PhaseScopePanel();
    ...
    public:
        ...
        // ═══ Toggle extra panels ═══════════════════════════════════════════
        void setShowDNA(bool show) noexcept
        {
            showDna_ = show;
            resized();
            repaint();
        ...
        void setShowWidth(bool show) noexcept
        {
            showWidth_ = show;
            resized();
            repaint();
        ...
        void setShowCrest(bool show) noexcept
        {
            showCrest_ = show;
            resized();
            repaint();
        ...
        void setShowAI(bool show) noexcept
        {
            showAi_ = show;
            resized();
            repaint();
